...
from butterfly_graph.constants import (
    DEFAULT_DB_PATH,
    DEFAULT_OPEN_NOTEBOOK_BUNDLE_PATH,
    DEFAULT_VAULT_PATH,
)
...
class Settings(BaseModel):
    ...
    open_notebook_bundle_path: Path = Path(
        os.getenv("BUTTERFLY_OPEN_NOTEBOOK_BUNDLE_PATH", DEFAULT_OPEN_NOTEBOOK_BUNDLE_PATH)
    )
